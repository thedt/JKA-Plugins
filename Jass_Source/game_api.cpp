...
//							файл мода			Папка		Сообщения движка	Сообщения мода		homepath
#ifdef WIN32
gameinfo_t g_GameInfo = {	"jampgamex86.dll",	"base",		JKA_eng_msg_names,	JKA_mod_msg_names,	NULL };
#else
gameinfo_t g_GameInfo = {	"jampgamei386.so",	"base",		JKA_eng_msg_names,	JKA_mod_msg_names,	"/.ja/" };
#endif

//Функции для преобразования сообщений в строковые
